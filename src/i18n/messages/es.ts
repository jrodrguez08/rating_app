export const esMessages = {
  ...
  standings: {
    ...
    periodic:
      "Actualizaci\u00f3n peri\u00f3dica; no representa cambios en vivo.",
    updated: "Actualizada {date}",
    unavailable: "La tabla no est\u00e1 disponible temporalmente.",
    rank: "#",
    team: "Equipo",
    played: "PJ",
    ...
    wonTitle: "Ganados",
    drawn: "E",
    drawnTitle: "Empatados",
    lost: "P",
    lostTitle: "Perdidos",
    goalDifference: "DG",
    goalDifferenceTitle: "Diferencia de goles",
    points: "Pts",
    pointsTitle: "Puntos",
    trackedTeam: "Equipo seguido",
  },
  home: {
    introduction:
